...
def plot_results(results, container, df_original=None):
    try:
        ...
        if has_confidence:
            future_styled_df["Lower_Bound"] = confidence_data["Lower_Bound"]
            future_styled_df["Upper_Bound"] = confidence_data["Upper_Bound"]
            future_styled_df["Confidence"] = confidence_data["Confidence"]
            future_styled_df.columns = ["Year-Month", "Forecasted Price", "Lower Bound", "Upper Bound", "Confidence (%)"]
        else:
